            ...
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="{{route('kategori.create')}}">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="{{route('produk.create')}}">
                      <span class="nav-main-link-name">Tambah</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="{{route('pembelian.create')}}">
                      <span class="nav-main-link-name">Tambah</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <a class="nav-main-link" href="{{route('pengeluaran.create')}}">
                      <span class="nav-main-link-name">Tambah</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
